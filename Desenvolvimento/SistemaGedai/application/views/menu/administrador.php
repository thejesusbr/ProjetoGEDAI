...
<ul class="navbar-nav my-lg-0">
    ...
    <li class="nav-item dropdown ">
        <a class="nav-link dropdown-toggle" href="#"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:whitesmoke">
            <i class="fas fa-user fa-sm"></i> Administrador
        </a>
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="{url}client/Usuario/gerenciar_usuarios"> Gerenciar Usuários </a>
            <a class="dropdown-item" href="{url}client/Eventos/gerenciar_eventos"> Gerenciar Eventos </a>
            <a class="dropdown-item" href="{url}client/Artigo/gerenciar_artigos"> Gerenciar Artigos </a>
        </div>
    </li>
