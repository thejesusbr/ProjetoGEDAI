<div class="row justify-content-end">
    <div class="col-sm-2">
        <a class="btn btn-warning btn-lg btn-block" href="{url}client/Artigo/gerenciar_artigos_pessoais"><i class="fas fa-arrow-left"></i>Voltar</a>
    </div>
</div>
...
<form method="POST" action="{url}client/Artigo/editar_artigo_pessoal/{id}" >
    {artigo}
