<form method="POST" action="{url}client/Artigo/novo_artigo" name="artigoForm">
    <div class="form-group">
        <label>Título:</label>
        <input type="text" name="titulo" class="form-control"  ng-model="titulo" ng-required="true">
    </div>
    <div class="form-group">
        <label>Autores: (caso não seja preenchido, o sistema usará seu nome)</label>
        <input type="text" name="autor" class="form-control" ng-model="autor">
    </div>
    <div class="form-group">
        <label>Objetivo: (Seja breve, use no máximo 200 caracteres)</label>
        <textarea class="form-control" name="objetivo" maxlength="200"></textarea>
    </div>
    <div class="form-group">
        <label>Texto:</label>
    ...
    <div class="form-group row justify-content-end">
        <button class="btn btn-primary btn-lg" ng-disabled="artigoForm.$invalid"> Adicionar </button>
    </div>
</form>
